...
const SiteVisitForm = ({
  ...
  const [slots, setSlots] = useState<(TimeSlot & {isPast: boolean})[]>([]);
          ...
          <div>
            ...
            {uniqueAddresses.length > 0 && (
              <div className="flex gap-3 mb-3">
                <Button
                  type="button"
                  variant={addressChoice === "existing" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setAddressChoice("existing")}
                >
                  Use Existing
                </Button>
                <Button
                  type="button"
                  variant={addressChoice === "new" ? "default" : "outline"}
                  size="sm"
            ...
            {addressChoice === "existing" && uniqueAddresses.length > 0 ? (
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  disabled={
                    !newAddr.address1 || !newAddr.city || !newAddr.pincode
                  }
                >
                  Save Address
                </Button>
